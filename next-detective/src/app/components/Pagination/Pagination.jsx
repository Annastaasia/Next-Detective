  ...
  return (
    <>
      ...
      <div className={style.pagination_wrapper}>
        ...
        >
          Показать еще 12
          <Image width={24} height={24} src={"/biege_arrow_down.svg"} alt="" />
        </button>
        <div className={style.numbers}>
          {currentPage >= 1 && (
            ...
            >
              <Image width={24} height={24} src={"/white_arrow_left.svg"} alt="" />
            </button>
          )}
          <span
          ...
          {currentPage <= totalPages && (
            ...
            >
              <Image width={24} height={24} src={"/white_arrow_right.svg"} alt="" />
            </button>
          )}
        </div>
      </div>
